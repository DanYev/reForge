...
def setup(sysdir, sysname):
    ...
    mdsys.martinize_proteins_en(ef=700, el=0.0, eu=0.9, from_ff='amber', append=True)  # Martini + Elastic network FF 
    ...
    mdsys.make_cg_topology(prefix='chain') # CG topology. Returns mdsys.systop ("system.top") file
    ...
    # 1.3. We can now insert the protein in a membrane. It may require a few attempts to get the geometry right.
